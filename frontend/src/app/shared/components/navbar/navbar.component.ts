          ...
          <div class="nav-center">
            <ul class="nav-links">
              ...
              @if (isLoggedIn && !isAdmin && !isTeacher) {
                <li><a routerLink="/student/adaptive/mon-niveau" routerLinkActive="active" (click)="closeMenu()">Mon niveau</a></li>
                <li><a routerLink="/student/learning-path" routerLinkActive="active" (click)="closeMenu()">Learning Path</a></li>
                <li><a routerLink="/student/progression" routerLinkActive="active" (click)="closeMenu()">Progression</a></li>
                <li><a routerLink="/student/level-test" routerLinkActive="active" (click)="closeMenu()">Test final</a></li>
              }
            </ul>
          </div>
            ...
            <div class="nav-actions">
              @if (isLoggedIn) {
                @if (isAdmin || isTeacher) {
                  <a [routerLink]="isAdmin ? '/admin/dashboard' : '/teacher/dashboard'" (click)="closeMenu()" class="btn btn-secondary btn-sm">
                  ...
                  <a routerLink="/student/adaptive/mon-niveau" (click)="closeMenu()" class="btn btn-outline btn-sm adaptive-btn">
