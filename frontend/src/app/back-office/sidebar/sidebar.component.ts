...
export class SidebarComponent implements OnInit {
  ...
  mainMenu = [
    ...
    { icon: 'flag', label: 'Modération Forum', route: '/admin/forum/moderation', exact: true, badge: '' },
    { icon: 'people', label: 'Users', route: '/admin/users', exact: false, badge: '' },
    { icon: 'school', label: 'Courses', route: '/admin/courses', exact: false, badge: '12' },
    { icon: 'groups', label: 'Students', route: '/admin/students', exact: false, badge: '' },
