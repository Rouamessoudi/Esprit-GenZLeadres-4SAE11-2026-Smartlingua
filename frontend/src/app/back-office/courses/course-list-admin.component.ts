  ...
  template: `
    <div class="page">
      <header class="page-header">
        ...
        <a [routerLink]="[coursesBase, 'new']" class="btn btn-primary">
      ...
      <section class="incomplete-section">
        ...
        <ul class="incomplete-list">
          @for (c of incompleteCourses; track c.id) {
            <li>
            <a [routerLink]="[coursesBase, c.id, 'detail']" class="incomplete-link">
              ...
              @for (c of courses; track c.id) {
                <tr>
                  ...
                  <td class="col-actions">
                    <a [routerLink]="[coursesBase, c.id, 'edit']" class="btn btn-sm btn-secondary" title="Modifier">Modifier</a>
                    <a [routerLink]="[coursesBase, c.id, 'detail']" class="btn btn-sm btn-outline" title="Ressources et séances">Contenu</a>
...
export class CourseListAdminComponent implements OnInit {
  ...
  ngOnInit() {
    this.coursesBase = this.authService.isTeacher() ? '/teacher/courses' : '/admin/courses';
    this.load();
    this.loadStatistics();
