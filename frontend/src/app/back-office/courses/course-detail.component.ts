  ...
  template: `
    <div class="detail-page">
      <div class="page-header animate-fade-in-up">
        ...
        <a [routerLink]="[coursesBase]" class="btn btn-outline btn-sm">
    ...
    @if (loading) {
      ...
      <div class="error-box animate-fade-in-up">
        ...
        <a [routerLink]="[coursesBase]" class="btn btn-primary">Retour à la liste</a>
      </div>
    } @else {
...
export class CourseDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (!idParam) {
      this.router.navigate([this.coursesBase]);
      return;
    }
    const id = +idParam;
