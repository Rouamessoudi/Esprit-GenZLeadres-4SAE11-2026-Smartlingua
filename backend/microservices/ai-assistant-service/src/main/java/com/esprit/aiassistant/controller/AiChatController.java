...
public class AiChatController {
    ...
    public ResponseEntity<ChatResponse> chat(
        ...
        log.info("POST /api/ai/chat userId={} conversationId={} messageLength={}",
                userId, request.getConversationId(), request.getMessage() != null ? request.getMessage().length() : 0);
        ...
        log.info("POST /api/ai/chat success userId={} conversationId={} replyLength={}",
                userId, response.getConversationId(), response.getReply() != null ? response.getReply().length() : 0);
