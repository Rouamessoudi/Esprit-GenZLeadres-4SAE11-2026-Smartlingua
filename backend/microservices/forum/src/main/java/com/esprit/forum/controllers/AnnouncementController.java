...
import com.esprit.forum.repositories.AnnouncementRepository;
...
public class AnnouncementController {
    ...
    public AnnouncementResponse create(@Valid @RequestBody AnnouncementRequest request, Authentication authentication) {
    ...
    private void validateAnnouncementRequest(AnnouncementRequest request) {
        ...
        if (trimToNull(request.content()) == null) {
