...
| **SmartLingua - Frontend** | Lance le frontend Angular sur le port **4200** (`npm start` dans `smartLingua/smartLingua`). |
...
- **package.json** : `c:\pi\smartLingua\smartLingua\package.json`
- **Scripts** : `start`
...
|-------|----------------|----------|
| 1 | Ouvrir le projet **backEnd** (`c:\pi\backend\backend\backEnd`) | Projet avec module messaging |
