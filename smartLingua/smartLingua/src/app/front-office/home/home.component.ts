...
import { hasSession, getSessionUser } from '../../core/services/local-session.service';
    ...
    <section class="hero">
      ...
      <div class="container hero-content">
        <div class="hero-text animate-fade-in-up">
          ...
          @if (isLoggedIn) {
            <div class="welcome-logged">
              <p>Bienvenue, <strong>{{ loggedUsername }}</strong>.</p>
              <a routerLink="/chat" class="btn btn-primary btn-lg">
...
export class HomeComponent {
    ...
    constructor() {
        ...
        this.loggedUsername = u?.username ?? '';
    }
